export const fi = {
  hero: {
    ...
    trustIndicators: [
      ...
      "Täysin varustetut huoneistot ja mökit"
    ]
  },
  about: {
    title: "Laadukas majoitus",
    titleHighlight: "Levin sydämessä",
    intro: "Etsitkö majoitusta parhailla sijainnilla Leviltä? Leville.net tarjoaa monipuolisen valikoiman huoneistoja ja vuokramökkejä aivan Levin keskustan parhailla paikoilla.",
    description: "Olitpa suunnittelemassa talvilomaa Levin laskettelurinteillä, kesäretkeä Lapin luontoon tai työmatkaa pohjoiseen, meiltä löydät sinulle sopivan majoitusratkaisun.",
    points: [
    ...
    imageAlt: "Majoituskuva"
  },
  features: {
    sectionId: "yritys",
    title: "Miksi valita",
    titleHighlight: "Leville.net?",
    subtitle: "Tarjoamme laadukasta majoitusta parhailla sijainneilla Levin keskustassa jo vuosien kokemuksella.",
    testimonialTitle: "Asiakkaidemme kokemuksia",
    prevAriaLabel: "Edellinen arvostelu",
    nextAriaLabel: "Seuraava arvostelu",
    dotAriaLabel: "Siirry arvosteluun",
    items: [
      {
  ...
  majoitukset: {
    ...
    subtitle: "Modernit huoneistot ja tunnelmallinen hirsihuvila Levin ydinkeskustassa – kävelymatkan päässä rinteistä, ravintoloista ja palveluista. Mökkiloman rauha keskustan tuntumassa, suoraan omistajalta ilman välityspalkkioita.",
    ...
    faqs: [
      ...
      { question: "Tarvitsenko auton Levillä?", answer: "Jos majoitut Levin keskustassa, et tarvitse autoa. Rinteet, ladut, ravintolat ja kaupat ovat kävelyetäisyydellä. Talvella Ski Bus liikennöi säännöllisesti (maksullinen, hissilipun yhteydessä tai erikseen). Jos mökki sijaitsee kauempana keskustasta (yli 2 km), auto on käytännössä välttämätön." },
      { question: "Onko majoituksissa sauna?", answer: "Lähes kaikissa Leville.netin kohteissa on oma sauna. Tämä on Suomessa normaalia mutta usein yllätys ulkomaalaisille vierailijoille. Kaikissa saunallisissa kohteissa on sähkölämmitteinen sauna.", link: "/sauna", linkText: "Lue saunaohjeet täältä" },
  ...
  yhteystiedot: {
    meta: {
      title: "Yhteystiedot | Leville.net – Ota yhteyttä",
      description: "Ota yhteyttä Leville.net asiakaspalveluun. Autamme sinua majoitusvarauksissa ja vastaamme kysymyksiisi Levin lomasta.",
      keywords: "Leville yhteystiedot, Levi majoitus yhteystiedot, Levi varaus",
      canonical: "https://leville.net/yhteystiedot"
    },
    title: "Yhteystiedot",
    subtitle: "Autamme sinua mielellämme! Ota yhteyttä ja kerro, miten voimme auttaa lomasuunnitelmissasi.",
    locationTitle: "Sijainti",
    mapTitle: "Leville.net sijainti kartalla",
    contactInfo: {
      email: "Sähköposti",
      phone: "Puhelin",
      address: "Osoite",
  ...
  ukk: {
    meta: {
      title: "Usein kysytyt kysymykset | Leville.net",
      description: "Vastauksia yleisimpiin kysymyksiin Leville.net majoituksista: sisäänkirjautuminen, peruutusehdot, lemmikit, WiFi ja paljon muuta.",
      keywords: "Leville UKK, Levi majoitus kysymykset, Levi varaus tiedot",
      canonical: "https://leville.net/ukk"
    },
    title: "Usein kysytyt kysymykset",
    subtitle: "Löydätkö vastauksesi alta? Jos ei, ota rohkeasti yhteyttä – autamme mielellämme!",
    faqs: [
      {
  ...
  yritys: {
    meta: {
      title: "Tietoa yrityksestämme | Leville.net – Majoitusta Levillä vuodesta 2011",
      description: "Leville.net on suomalainen yritys, joka tarjoaa laadukasta majoitusta Levillä vuodesta 2011. Vuokraamme omia huoneistoja ja mökkejä – edulliset hinnat ja henkilökohtainen palvelu.",
      keywords: "Leville.net yritys, majoitus Levi, huoneisto Levi, mökki Levi, loma-asunto Lappi",
      canonical: "https://leville.net/yritys"
    },
    title: "Yrityksemme",
    subtitle: "Etsitkö majoitusta Leviltä helposti, nopeasti ja ilman välikäsiä?",
    ...
    servicesTitle: "Meiltä saat",
    customTitle: "Räätälöityjä ratkaisuja",
    customText1: "Teemme räätälöityjä tarjouksia isoille ryhmille, matkatoimistoille ja yrityksille. Jos suunnittelet talvilomaa Levillä, kesälomaa Lapissa tai tarvitset huoneiston Leviltä pidemmäksi aikaa, ota rohkeasti yhteyttä. Pyrimme aina joustamaan tulo- ja lähtöajoissa, mikä tekee meistä suositun myös loma-asuntojen vuokraajille Levillä.",
    customText2: "Kaikki huoneistomme ovat siistejä, hyvin varusteltuja ja kodikkaita. Monissa kohteissa on myös viilennys, joka on erinomainen lisä kesäkuukausina. Sijainnimme ovat erinomaisia – huoneistot sijaitsevat Levin keskustassa, lähellä rinteitä, hiihtolatuja, kauppoja, ravintoloita ja ohjelmapalveluita.",
    whyTitle: "Miksi valita Leville.net?",
    testimonialsTitle: "Asiakkaiden kokemuksia",
    testimonialsSubtitle: "Lue mitä asiakkaamme sanovat majoituksistamme",
    ctaText: "Olitpa tulossa laskettelemaan, golfaamaan, nauttimaan Lapin luonnosta tai työreissulle pohjoiseen, <span class=\"text-foreground font-semibold\">Leville.net</span> tarjoaa parasta majoitusta Levillä – suoraan ja helposti.",
    exploreCta: "Tutustu kohteisiimme",
    contactCta: "Ota yhteyttä",
    services: [
      { title: "Huoneistomajoitus Levillä", description: "Yksiöistä suuriin lomahuoneistoihin" },
      { title: "Mökki vuokralle Leviltä", description: "Kodikkaat mökit Lapin tunturimaisemissa" },
      { title: "Loma-asunto Levi", description: "Täydellinen vaihtoehto perheille ja ystäväporukoille" },
      { title: "Yritysmajoitus Levillä", description: "Joustavat ratkaisut työmatkailuun ja tiimeille" },
      { title: "Majoitus Lapissa", description: "Suoraan omistajalta – ilman välikäsiä, ilman piilokuluja" }
    ],
    benefits: [
  ...
  levi: {
    ...
    weatherCta: "Katso säätiedot",
    mapTitle: "Levin kartta",
    ...
    gallery: [
      ...
      { alt: "Levin laskettelurinteet kirkkaana talvipäivänä", caption: "Levin rinteet" },
      { alt: "Nuotiohetki lumisessa Lapin maisemassa", caption: "Tunnelmaa nuotiolla" },
      { alt: "Poro lähikuvassa Lapissa", caption: "Lapin asukkeja" },
      { alt: "Hiihtoladut aurinkoisena päivänä", caption: "Ladut kutsuvat" },
      { alt: "Levin tunturimaisema keväällä", caption: "Tunturimaisema" }
    ],
    usefulLinks: [
