...
const translations = {
    ...
    meta: {
      ...
      description: "Levin ravintolat, ruokakaupat, urheiluvälinevuokraamot ja palvelut. Aukioloajat, perheystävälliset vaihtoehdot ja käytännön vinkit.",
    ...
    intro: "Levin keskustasta löydät kaikki tarvittavat palvelut: ravintolat joka makuun, ruokakaupat, urheiluvälinevuokraamot ja terveyspalvelut. Tässä oppaassa kaikki mitä tarvitset tietää.",
    sections: {
      restaurants: {
        title: "Ravintolat Levillä",
        icon: "utensils",
        intro: "Levillä on monipuolinen ravintolatarjonta perinteisestä lappalaisesta ruoasta kansainväliseen keittiöön:",
        categories: [
          {
          ...
          },
          {
            ...
            note: "Noutomyynti rinteiden läheisyydestä lounastauolle."
          },
          {
            name: "Après-ski & baarit",
            places: ["Hullu Poro Arena", "Tuikku", "Levin Panimo"],
            note: "Rinteen jälkeen rentoutumista ja tunnelmaa."
          }
        ],
      ...
      groceries: {
        ...
        stores: [
          ...
          {
            name: "Sale Levi",
            location: "Zero Point -alue",
            hours: "Ma–La 8–21, Su 10–21",
            note: "Perusvalikoima, edullisempi vaihtoehto."
          }
        ],
        tips: [
        ...
        shops: [
          {
            ...
            location: "Useita toimipisteitä rinteillä ja keskustassa"
          },
          {
  ...
  en: {
    meta: {
      ...
      description: "Levi restaurants, grocery stores, sports equipment rentals and services. Opening hours, family-friendly options and practical tips.",
    ...
    intro: "Levi center has all the services you need: restaurants for every taste, grocery stores, sports equipment rentals and health services. This guide covers everything you need to know.",
    sections: {
      restaurants: {
