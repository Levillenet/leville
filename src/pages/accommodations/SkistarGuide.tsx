...
const i18n = {
  en: {
    ...
    aboutP3: "All services in Levi centre are within walking distance — the supermarket, restaurants, souvenir shops and kids' land are just a few minutes on foot. The front slopes and lifts are about 700 metres away (roughly an 8–10 minute walk). The closest snowmobile track is approximately 200 metres away.",
    ...
    aboutP3: "Kaikki Levin keskustan palvelut ovat kävelymatkan päässä — kauppa, ravintolat, matkamuistomyymälät ja lastenalue ovat vain muutaman minuutin kävelyn päässä. Eturinteet ja hissit ovat noin 700 metrin päässä (n. 8–10 minuutin kävely). Lähin moottorikelkkareitti on noin 200 metrin päässä.",
