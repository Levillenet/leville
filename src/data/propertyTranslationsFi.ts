...
**Kaikki sisältyy mukavaan oleskeluun** Täysin varusteltu keittiö, jossa astianpesukone, uuni, mikroaaltouuni ja kahvinkeitin. Yksityinen sauna rinnetemoin. Takka polttopuineen sisältyy hintaan. 3 parveketta. Ilmastointi. Ilmainen WiFi, TV ja äänentoistojärjestelmä. Pinnasänky, syöttötuoli, lastenkirjoja ja -leluja sekä lasten turvaportit saatavilla.`,
  ...
  "karhupirtti": {
    ...
    shortDescription:
      "220 m² perinteinen hirsihuvila Levin keskustassa: 7 makuuhuonetta, ulkoporeallas, oma piha ja takka. 3 ensuite-makuuhuonetta alakerrassa (oma suihku + WC), erillinen kylpyhuone saunan yhteydessä sekä 2 erillistä WC:tä. Täysin remontoitu 2022. Takkapuut sisältyvät. Lemmikit sallittu.",
...
**Tilaa jopa 14 vieraalle 7 makuuhuoneessa** Alakerrassa on kolme omalla kylpyhuoneella varustettua makuuhuonetta, jokaisessa oma suihku ja WC – täydellistä yksityisyyttä arvostaville. Yläkerrassa on neljä makuuhuonetta väliovilla, ihanteellinen lapsiperheille. Saunan yhteydessä on lisäksi oma erillinen kylpyhuone, ja huvilassa on vielä **2 erillistä WC:tä** yhteiskäyttöön – ruuhkaa ei pääse syntymään isonkaan ryhmän kanssa. Yhteensä kylpytiloja on siis 4 kylpyhuonetta + 2 erillistä WC:tä. Tilava olohuone ja ruokailutila istuttavat koko ryhmän mukavasti, tehden yhteisistä aterioista ja illoista loman kohokohtia.
