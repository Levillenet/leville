...
const Hero = () => {
  return <section className="relative min-h-screen flex items-center justify-center hero-gradient pt-20 pb-32" style={{
    overflow: 'visible'
  }}>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-10 right-1/4 w-[500px] h-[350px] bg-gradient-to-b from-aurora-blue/15 via-aurora-green/8 to-transparent rounded-full blur-3xl animate-aurora" style={{
        animationDelay: '-5s'
      }} />
      </div>
      ...
      {/* Snow/stars effect */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {[...Array(30)].map((_, i) => <div key={i} className="absolute w-1 h-1 bg-foreground/30 rounded-full" style={{
      ...
      overflow: 'visible'
        ...
        overflow: 'visible'
          ...
          {/* Trust indicators */}
          <div className="mt-16 flex flex-wrap items-center justify-center gap-8 text-sm text-muted-foreground animate-fade-in" style={{
          animationDelay: '0.6s'
        }}>
