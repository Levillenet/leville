...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center hero-gradient pt-20 pb-32" style={{ overflow: 'visible' }}>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-10 right-1/4 w-[500px] h-[350px] bg-gradient-to-b from-aurora-blue/15 via-aurora-green/8 to-transparent rounded-full blur-3xl animate-aurora" style={{ animationDelay: '-5s' }} />
      </div>
