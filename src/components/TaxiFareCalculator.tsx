...
const TaxiFareCalculator = ({ lang = "fi" }: TaxiFareCalculatorProps) => {
  ...
  const fare = useMemo(() => {
    ...
    const timeRate = 1.15;
    const avgSpeed = 40; // km/h in village area
      ...
      <CardContent className="pt-6">
        ...
        <div className="mb-5">
          <label className="text-sm font-medium flex items-center gap-1.5 mb-2">
            <Users className="w-4 h-4" /> {t.passengers}
          </label>
        ...
        <div className="mb-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            {routes.map((r) => (
              ...
              >
                {r.isAirport && <Plane className="w-3.5 h-3.5 mr-1.5 flex-shrink-0" />}
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-sm">
                <span className="flex items-center gap-1">
                  <Plane className="w-3.5 h-3.5" /> {t.fixedPrice}
                </span>
