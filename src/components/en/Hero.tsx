    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div 
          ...
          style={{ animation: 'auroraMove1 6s ease-in-out infinite' }}
        />
        <div
          ...
          style={{ animation: 'auroraMove2 7s ease-in-out infinite' }}
        />
        <div
          ...
          style={{ animation: 'auroraMove3 8s ease-in-out infinite' }}
        />
      </div>
        ...
        {sparkles.map((sparkle) => (
          ...
          >
            <svg width="16" height="16" viewBox="0 0 16 16" className="text-white drop-shadow-[0_0_4px_rgba(255,255,255,0.8)]">
              <path d="M8 0L9 6L15 7L9 8L8 14L7 8L1 7L7 6L8 0Z" fill="currentColor" />
            </svg>
          </div>
        ))}
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10" style={{ overflow: 'visible' }}>
        <div className="max-w-4xl mx-auto text-center" style={{ overflow: 'visible' }}>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-semibold text-foreground mb-6 animate-slide-up tracking-tight">
            Welcome to <span className="text-gradient">Levi</span>
          </h1>
          ...
          >
            Stay comfortably in Levi center – modern apartments and cozy cabins in the best locations
          </p>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="font-display text-sm md:text-base lg:text-lg text-foreground/90 tracking-widest uppercase font-medium">Best locations in center</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="w-2 h-2 bg-aurora-green rounded-full shadow-[0_0_8px_hsl(160_60%_45%/0.6)]" />
              <span className="font-display text-sm md:text-base lg:text-lg text-foreground/90 tracking-widest uppercase font-medium">Book directly from us</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="w-2 h-2 bg-aurora-green rounded-full shadow-[0_0_8px_hsl(160_60%_45%/0.6)]" />
              <span className="font-display text-sm md:text-base lg:text-lg text-foreground/90 tracking-widest uppercase font-medium">Personal service</span>
            </div>
          </div>
        </div>
      </div>
